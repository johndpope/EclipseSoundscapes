...
class PartnersViewController : FormViewController {
    ...
    var members : [Partner] = [
        Partner(name: "Arlindo Goncalves", website: "iOS Developer", bio: "Arlindo is an iOS developer from Brockton, Ma and also a Computer Science student at UMass Boston. He has aspirations to develop applications that help schools or any other institution engage the youth and make education a focus point in their lives. Besides  that, Arlindo spends his time playing soccer and cooking for his family and friends.", photo: #imageLiteral(resourceName: "Arlindo"))]
